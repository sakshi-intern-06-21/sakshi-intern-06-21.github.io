...
<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<p>
		<i class="icon-phone" style="font-size:24px"></i> <span class="i-name fontgrey">Phone</span><span class="i-code">&emsp; 8788943354</span><br>
        <i class="icon-mail-alt"style="font-size:24px"> </i> <span class="i-name fontgrey">Email</span><span class="i-code">&emsp; saku.kharche@gmail.com</span>
		</p><hr>
		<div class="row">
			<div class="large-12 columns" >
					...
					<form action="pay.php" method="post" target="_top">
