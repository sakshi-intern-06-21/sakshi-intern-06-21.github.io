		  ...
		  <div class="row">
			...
			<div class="large-6 columns">
			  <label class="" style="color:black !important;">Telephone Number*
				<input name="phone" type="text" id="" value="<?php if(isset($_SESSION['phone']) && !empty($_SESSION['phone'])){echo  $_SESSION['phone'];}?>" pattern= "[^a-zA-Z]+" Title="Only numbers are allowed"  placeholder="" size="35"/>
			  </label>
			</div>
		  </div>
		  <div class="row">
